...
def gen_one_aux_file(pocket_path, pocket_name, protein_name, output_path):
    ...
    f = open(output_path + pro_base[0] +'_'+ base + '_aux.txt', 'w')
...
def gen_all_aux_file(pocket_path, protein_path, output_path):
    protein_list=[]
...
if __name__ == "__main__":
    ...
    output_path = '../data/original_data/aux_files/'
    gen_all_aux_file(pocket_path=pocket_path, protein_path=protein_path, output_path=output_path)
