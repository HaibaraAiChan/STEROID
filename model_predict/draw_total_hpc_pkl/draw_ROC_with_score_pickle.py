...
if __name__ == "__main__":
    ...
    # file = open('./128/direct_total_score.pkl', 'r')
    # file = open('./128/generator_no_shuffle_score.pkl', 'r')
    # file = open('./64/64_direct_total_score.pkl', 'r')
    file = open('./64/generator_no_shuffle_score.pkl', 'r')
